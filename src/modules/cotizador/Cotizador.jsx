...
// ─── MAIN ────────────────────────────────────────────────────────────────────
// Productos y Presentaciones CRUD → Administración → tab Productos
  ...
  return (
    <div style={{ fontFamily:'inherit', maxWidth:1100 }}>
      <div style={{ marginBottom:22 }}>
        ...
        <p style={{ fontSize:'.83rem', color:T.textMid, marginTop:4 }}>Generación de cotizaciones para clientes</p>
      </div>
      <TabCotizaciones/>
    </div>
  );
